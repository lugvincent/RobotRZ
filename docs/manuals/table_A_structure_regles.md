...
Le tableau suivant donne la vue d'ensemble des 14 champs. La description détaillée de chacun suit dans la section 2.
...
**Ancien nom :** aucun — nom stable depuis l'origine  
...
**Anciens noms :** catégorie, type_message  
...
**Anciens noms :** type_valeur, type_logique  
